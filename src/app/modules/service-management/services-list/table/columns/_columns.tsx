...
import { ServiceNestedActionsCell } from './ServiceNestedActionsCell'
...
const servicesColumns: ReadonlyArray<Column<Service>> = [
  ...
  {
    Header: (props) => <ServiceCustomHeader tableProps={props} title='Онлайн захиалга' className='min-w-115px' />,
    id: 'resources',
    Cell: ({...props}) => <InfoCell data={
      props.data[props.row.index].is_app_option === 1 ? 'Тийм' : props.data[props.row.index].is_app_option === 0 ? 'Үгүй' : ''
    } />,
  },
  {
  ...
  },
  {
    ...
    id: 'nestedActions',
    Cell: ({...props}) => <ServiceNestedActionsCell id={props.data[props.row.index].id} />,
  },
]
