...
import {deleteSelectedCoupons} from '../../core/_requests'

const CouponsListGrouping = () => {
  const {selected, clearSelected} = useListView()
  const queryClient = useQueryClient()
  const {query} = useQueryResponse()

  const deleteSelectedItems = useMutation(() => deleteSelectedCoupons(selected), {
