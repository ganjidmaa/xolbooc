...
import {deleteSelectedCodes} from '../../core/_requests'

const CouponCodesListGrouping = () => {
  const {selected, clearSelected} = useListView()
  const queryClient = useQueryClient()
  const {query} = useQueryResponse()

  const deleteSelectedItems = useMutation(() => deleteSelectedCodes(selected), {
...
export {CouponCodesListGrouping}
