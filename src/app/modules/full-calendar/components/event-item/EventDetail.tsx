      ...
      <div className='card pb-4 h-lg-600px'>
        <div className='card-header'>
          <div className='card-title d-flex justify-content-between w-100 me-0'>
            <div className='d-flex align-items-center'>
              ...
              {event && (
                <span style={datePickerProps.style}>
        ...
        <div className='card-body '>
          ...
          >
            {event &&
              event.item_values &&
              objectHasAttr(event.item_values) &&
              event.item_values.map((item, index) => {
                totalDuration += parseInt(item?.duration || '0')
                totalPayment += parseInt(item?.price || '0')
                return <ItemDetail key={index} item={item} viewType='view' />
              })}
          </div>
