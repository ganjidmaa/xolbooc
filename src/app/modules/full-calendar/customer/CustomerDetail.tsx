    ...
    <div>
      <div className='d-flex flex-center pb-3'>
        ...
        <div className=''>
          <div
            className={clsx(
              'fs-3 text-gray-800 fw-bolder mb-1',
              !customer?.deleted_at && `text-hover-primary`
            )}
            onClick={() => {
              linkToCustomerDetail()
            }}
          >
          ...
          <div className='fs-5 fw-bold text-muted mb-1'>
            {[ROLES.ADMIN, ROLES.RECEPTION].includes(userRole) && <>{customer?.phone} {customer?.phone2}</>} 
          </div>
        </div>
      </div>
      ...
      <div className='d-flex flex-wrap flex-center w-100'>
        <div
          ...
          style={{width: '30%'}}
        >
          <div className='d-flex flex-column flex-sm-row fs-7 fw-bolder text-gray-700'>
            <div className='pe-4'>
              {' '}
          ...
          >
            {status && (
              <>
                ...
                <KTSVG path='/media/icons/duotune/arrows/arr072.svg' className='svg-icon-1 ps-2' />
              </>
            )}
          </Link>
