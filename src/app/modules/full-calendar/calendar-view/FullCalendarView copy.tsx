      ...
      <div className='card-body'>
        ...
        {slotMinTime && slotMaxTime &&(
          <FullCalendar
            ...
            //     endTime: '12:00', // Lunch break starts at 12 PM
            //   },
            //   // Afternoon hours (after lunch)
            //   {
            //     daysOfWeek: [1, 2, 3, 4, 5], // Monday - Friday
            //     startTime: '13:00', // After lunch
            //     endTime: '18:00', // End of working day
            //   },
            // ]}
            ...
            selectAllow={(selectInfo) => {
              ...
              // Block lunch from 12:00 to 13:00
              return !(start >= 12 && start < 13 || end > 12 && end <= 13);
            }}
      
            // Prevent dragging events into lunch hour
            eventConstraint={{
              start: '09:00', // Service hours start
              end: '18:00',   // Service hours end
            }}
            ...
            dateClick={function (info) {
              // if (businessDays.includes(Moment(info.date).format('d'))) {
                if (userCanCreateEvents(userRole)) {
                  ...
                  // console.log('clickedElement', clickedElement.classList)
